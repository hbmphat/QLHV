                ...
                <?php foreach ($data as $item): ?>
                    <div class="course-card" data-id="<?php echo $item['id']; ?>">
                        <div class="co-header">
                            ...
                            <button class="btn-edit-level" title="Sửa cấp độ" onclick='openLevelModal(true, <?php echo json_encode($item, JSON_HEX_APOS | JSON_HEX_QUOT); ?>)'>
                                        ...
                                        <li class="package-item">
                                            ...
                                            <div style="display:flex; align-items:center;">
                                                ...
                                                <span class="material-symbols-outlined btn-edit-pkg"
                                                    title="Sửa giá"
                                                    onclick="openPackageModal(<?php echo $item['id']; ?>, '<?php echo htmlspecialchars($item['level_name'], ENT_QUOTES); ?>', true, <?php echo json_encode($p, JSON_HEX_APOS | JSON_HEX_QUOT); ?>)">
                                                    edit
                                                </span>
                                            </div>
                                        </li>
